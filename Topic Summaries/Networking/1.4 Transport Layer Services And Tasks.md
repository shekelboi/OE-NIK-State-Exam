...
3. The sender sends and ACK to acknowledge the receiver's SYN.
...
The initial sequence number is actually a randomly selected number, in this case for simplicity relative sequence numbers are used starting from 0.
